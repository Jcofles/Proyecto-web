...
const DESTINO_PRESETS = [
  ...
  { keys: ['Salón D 103', 'Salon D 103'], label: 'Salón D 103' },
  { keys: ['Salón D 104', 'Salon D 104'], label: 'Salón D 104' },
  { keys: ['Salón D 105', 'Salon D 105'], label: 'Salón D 105' },
  { keys: ['Salón D 106', 'Salon D 106'], label: 'Salón D 106' },
  { keys: ['Salón D 107', 'Salon D 107'], label: 'Salón D 107' },
  { keys: ['Salón D 108', 'Salon D 108'], label: 'Salón D 108' },
  { keys: ['Salón D 109', 'Salon D 109'], label: 'Salón D 109' },
  { keys: ['Salón D 110', 'Salon D 110'], label: 'Salón D 110' },
